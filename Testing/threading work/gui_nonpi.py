...
# TODO: To get this running, make sure you have a database file that's valid
#    the alpr file locations are properly described and you finally have a valid picture to check
