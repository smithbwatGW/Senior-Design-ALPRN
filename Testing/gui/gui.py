...
exit = Tkinter.Button (window,pady=1,padx=5,text="Exit",command=exit_buttoncall,bg="red")
...
exit.place(relheight=bottom_row_height,relwidth=0.1,relx=0,rely=1-bottom_row_height)
